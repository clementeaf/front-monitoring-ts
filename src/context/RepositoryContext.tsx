...
import useRepositoryInfoQuery, { FetchRepositoryInfoResponse } from '../hooks/useRepositoryInfoQuery';
...
export function RepositoryProvider({ children }: RepositoryProviderProps) {
  ...
  const repositoryContextValue = {
    repositoryInfo: repositoryInfoQuery.data || { data: undefined, error: undefined },
  };
